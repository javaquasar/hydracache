...
function InventoryPanels() {
  return (
    <>
      <Panel id="members" title="Committed members" description="waiting for members" aside={<TrustNote>one epoch · bounded to 48 rows</TrustNote>}><p data-testid="render-cap" class="visually-associated">waiting for members</p><DataTable label="Committed members" headings={["Member", "Raft role", "Reachability", "Generation", "CPU", "RSS", "Retained", "Uptime", "Clients", "Partitions", "Config digest"]} bodyTestId="members-list" /></Panel>

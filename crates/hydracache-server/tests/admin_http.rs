...
use hydracache_server::{
    ...
    ServerRuntime, TlsConfig, ADMIN_BACKUP_PATH, ADMIN_DRAIN_PATH, ADMIN_READYZ_PATH,
...
async fn admin_action_failure_is_loud_not_silent() {
    let local_surface = AdminHttpSurface::new(ServerRuntime::new(local_config()).unwrap().start());

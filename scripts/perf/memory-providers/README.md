...
high-fanout, M6 gRPC+mTLS slow-consumer, M7 sled-persistence, and all four M8
duration state machines in a cgroup-v2 Linux container. The output directory
must be new and empty; the

...
high-fanout, M6 gRPC+mTLS slow-consumer, M7 sled-persistence, all four M8
duration state machines, and the M9/M10 multi-scenario schedules in a cgroup-v2
Linux container. The output directory must be new and empty; the

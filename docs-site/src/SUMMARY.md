...
- [Cache Semantics](concepts/cache-semantics.md)
- [Keys and Tags](concepts/keys-and-tags.md)
- [Single-flight](concepts/single-flight.md)
- [TTL and Invalidation](concepts/ttl-and-invalidation.md)
- [Local-first Invalidation](concepts/local-first-invalidation.md)
- [Typed Query Caching](concepts/typed-query-caching.md)
- [What HydraCache Is Not](concepts/what-hydracache-is-not.md)

# Guides

- [Local Cache](guides/local-cache.md)
- [Cacheable Functions](guides/cacheable-functions.md)
- [Typed Cache](guides/typed-cache.md)
- [Refresh and Stale Reads](guides/refresh-and-stale-reads.md)
- [Macros](guides/macros.md)
- [Database Query Caching](guides/database-query-caching.md)
- [SQLx Adapter](guides/sqlx-adapter.md)
- [Diesel Adapter](guides/diesel-adapter.md)

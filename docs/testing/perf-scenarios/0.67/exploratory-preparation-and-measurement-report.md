...
The report generated from that artifact is the authoritative run record:
[results/20260803T000000Z-rejected-irq/report.md](../../../../results/20260803T000000Z-rejected-irq/report.md).
...
The dedicated host was `hydracache-perf-v1` at `62.210.158.50`, accessed as
`hydracache-admin`. The following preparation sequence was used.

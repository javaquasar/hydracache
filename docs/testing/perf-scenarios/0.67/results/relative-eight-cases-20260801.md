...
the malformed files from the rejected first attempt) is retained in the
[exact archive tree](https://github.com/javaquasar/hydracache/tree/dbc2f82f7f303528b3cca7842818730c82232b9c/docs/testing/perf-scenarios/0.67/results/relative-eight-cases-20260801/artifacts):

`docs/testing/perf-scenarios/0.67/results/relative-eight-cases-20260801/artifacts/`

At collection time, an independent checksum/provenance copy also remained at
`C:\Workspace\prj\jq\cashe\.heartbeat-artifacts\manual\relative-eight-cases-20260801`
on the operator workstation; that local path is historical context, not part

...
Open for the `0.21.x` release line.
...
["protobuf-codec"] }` for `0.21.0`, document the upstream advisory, and ignore
...
The current dependency audit also reports unmaintained transitive crates:
...
part of the same dependency-health review.

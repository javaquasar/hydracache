...
| [0.45.0](V0_45_ACTIVE_ACTIVE_MULTIREGION_PLAN.md) | in-progress | Bounded-staleness writes, CRDT value types, WAN transport + anti-entropy, region failover/DR, capacity signals, geo observability | Local-latency writes across regions under a documented staleness contract | 0.44 | 0.46 |

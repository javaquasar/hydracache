...
> **0.67 status note (2026-07-26):** W0-W10 implementation closure is present and the release
> remains `in-progress` pending its ordinary version/ship PR. The release scope is measurement
> infrastructure without numerical claims. Dedicated `reference-v1` bootstrap and final reference
> evidence are deferred to TD-0013; the profile remains unbootstrapped.

...
0.37 DB production hardening ──► 0.38 DB correctness automation
   ...
   0.66 ─┄ feeds ┄► 0.67 Performance Characterization & Capacity Baselines
                          ...
                          the annotated v0.66.0 predecessor is present and ancestral; reference-v1 W7
                          anchor/budgets/baseline are unbootstrapped pending at least five eligible
                          dedicated main runs and independent review.)
...
> **0.67 status note (2026-07-21):** W0-W10 implementation closure is present, but the release
> remains `in-progress` and is not shipped. The annotated `v0.66.0` predecessor is present and
> ancestral; the `reference-v1` W7 anchor/budgets/baseline remain unbootstrapped pending at least
> five eligible dedicated `main` runs plus independent review and final exact-candidate receipts.

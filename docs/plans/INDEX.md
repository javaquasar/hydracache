...
0.37 DB production hardening ──► 0.38 DB correctness automation
   ...
   0.62.1 ─┄ feeds ┄► 0.63 Redis RESP Edge Facade (OUTWARD adoption: optional,
                          ...
                          atomic MSET, Redis TTL through client-protocol v3 metadata/expiry,
                          Redis AUTH/HELLO AUTH + explicit TLS/rediss posture, HC.* native-or-unsupported;

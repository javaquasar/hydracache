...
- The repository currently has no local `v0.65.0` tag. Mixed-version development proof is green
  against the pinned 0.65 implementation base, while ship mode intentionally fails until the real
  full-history tag is present.

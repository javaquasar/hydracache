...
the 0.67.1 bare-metal evidence campaign was unavailable and remained deferred
when 0.68 shipped, without blocking this Rust release or authorizing numerical
performance claims. That campaign completed later as a separate evidence milestone.
